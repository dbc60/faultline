/**
 * @file index_generic_tests.c
 * @author Douglas Cuthbertson
 * @brief Tests for index_generic.h bit-scan macros, index-by-value macros/function,
...
FL_GET_TEST_SUITE("Index (Generic)", ts)
