#ifndef INDEX_GENERIC_H_
#define INDEX_GENERIC_H_

/**
 * @file index_generic.h
 * @author Douglas Cuthbertson
 * @brief Generic (portable) implementations of bit-scan macros, index-by-value
 * macros/function, and bin limit macros. Uses binary search algorithms with no
 * platform intrinsics required. This is a drop-in replacement for index_windows.h.
 * @version 0.2
 * @date 2023-03-05
 *
 ...
 * This is a portable implementation of the same algorithm.
 *
 * @param val the value to be indexed
