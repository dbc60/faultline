...
::   1. produce the memory_service, log_service, and exception_service packages
::   2. import all three into one unified tree (fl_import refcounts shared files)
...
::   5. run the driver, which loads the DLL and injects all three services
::
...
:: -----------------------------------------------------------------------
:: 2. Import all three into one unified tree.
:: -----------------------------------------------------------------------
