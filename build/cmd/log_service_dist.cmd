...
::
:: Collect the log service package into dist\log_service\.
::
:: Usage:
...
:: Derive DIR_REPO from this script's location (build\cmd\log_service_dist.cmd)
SET DIR_CMD=%~dp0
...
SET DIR_DIST=%DIR_REPO%\dist\log_service
...
ECHO.
ECHO Done. Package written to dist\log_service\
ECHO.
ECHO   Consumer include path : dist\log_service\include
ECHO   Compile these sources : dist\log_service\src\*.c
