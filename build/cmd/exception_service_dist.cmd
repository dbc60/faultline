...
:: Derive DIR_REPO from this script's location (build\cmd\exception_service_dist.cmd)
SET DIR_CMD=%~dp0
...
SET DIR_DIST=%DIR_REPO%\dist\exception_service
...
SET SVC_NAME=exception_service
...
ECHO.
ECHO Done. Package written to dist\exception_service\
ECHO.
ECHO   Consumer include path : dist\exception_service\include
